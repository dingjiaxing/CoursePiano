...
//        listViewAudio = (ListView) findViewById(R.id.listViewAudioFile);
    ...
    private void initData() {
        if (!SDcardTools.isHaveSDcard()) {
            Toast.makeText(KeyboardActivity.this, "请插入SD卡以便存储录音",
        ...
        adaperListAudio = new ArrayAdapter<String>(KeyboardActivity.this,
        ...
        buttonDeleted.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fileAudio != null) {
                    ...
                    ShowDialog.showTheAlertDialog(KeyboardActivity.this, "该文件不存在");
                }
            }
        });
    ...
    public void doClick(View v){
        ...
        for(int i=15;i<25;i++){
            if(buttonId[i]==v.getId()){
                MediaPlayer mp=MediaPlayer.create(KeyboardActivity.this,BlackVoice[i-15]);
                mp.start();
            }
        }
    }
